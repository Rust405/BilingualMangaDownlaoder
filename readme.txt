...
2. Requires beautifulsoup, execute "py pip install beautifulsoup4" before running if not installed
3. Comes with download progress and time estimate
4. Error handling is limited to when the image link is broken or invalid.
